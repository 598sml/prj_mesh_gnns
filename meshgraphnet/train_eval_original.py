...
def train(data_train, data_valid, stats_list, cfg):
    ...
    # Define the model name for saving checkpoints
    # model_name = utils.
    ...
    for epoch in range(cfg.training.num_epochs):
        ...
        if epoch % 10 == 0:
            ...
            avg_valid_loss = total_valid_loss / max(num_valid_batches, 1)
    ...
    return model, train_losses, valid_losses, best_model, best_valid_loss
